...
{
    static List<object> allObjects;

    public static void AddObjects(Player Player)
    {
        allObjects.Add(Player);
    }

    public static void RemoveObjects(Player Player)
    {
        allObjects.Remove(Player);
    }

    public static void CallMethods(String MethodName)
    {
    ...
    public static void Initialized()
    {
        ...
        Program.TypeTextWithThreadSleep($"正在進行初始化...");
